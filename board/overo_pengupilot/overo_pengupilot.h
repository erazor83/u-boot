...
#define MUX_OVERO() \
 ...
 /*Bluetooth*/\
	...
	MUX_VAL(CP(UART1_CTS),		(IEN  | PTU | EN  | M4)) /*GPIO_150-MMC3_WP*/\
 ...
 /*Control and debug */\
	...
	MUX_VAL(CP(ETK_CLK_ES2),	(IEN  | PTD | EN  | M4)) /*MMC3_CLK*/\
	MUX_VAL(CP(ETK_CTL_ES2),	(IEN  | PTD | EN  | M4)) /*MMC3_CMD*/\
	...
	MUX_VAL(CP(ETK_D2_ES2),		(IEN  | PTU | EN  | M4)) /*GPIO_16*/\
								 /* - W2W_NRESET*/\
	MUX_VAL(CP(ETK_D3_ES2),		(IEN  | PTD | EN  | M4)) /*MMC3_DAT3*/\
	MUX_VAL(CP(ETK_D4_ES2),		(IEN  | PTD | EN  | M4)) /*MMC3_DAT0*/\
	MUX_VAL(CP(ETK_D5_ES2),		(IEN  | PTD | EN  | M4)) /*MMC3_DAT1*/\
	MUX_VAL(CP(ETK_D6_ES2),		(IEN  | PTD | EN  | M4)) /*MMC3_DAT2*/\
